...
class Juego:
    ...
    #recorre una habitacion
    def recorrer_habitacion (self, elem_mapa):
        if elem_mapa.es_habitacion():
            elem_mapa.entrar(self.posicion)
            self.posicion+=1

    #recorre las habitaciones
    def recorrer_habitaciones (self):
        self.laberinto.recorrer(self.recorrer_habitacion)
